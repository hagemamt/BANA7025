...
```{r}
p1 <- songs %>% 
  ggplot(aes(x = danceability, y = playlist_genre, fill = playlist_genre)) + 
  geom_boxplot() + 
  theme(legend.position = "NONE") + 
  scale_y_discrete(name = NULL) + 
  theme(panel.grid.major.y = element_blank()) 
p2 <- songs %>% 
  ggplot(aes(x = energy, y = playlist_genre, fill = playlist_genre)) + 
  geom_boxplot() + 
  theme(legend.position = "NONE") + 
  scale_y_discrete(name = NULL) + 
  theme(panel.grid.major.y = element_blank()) 
p3 <- songs %>% 
  ggplot(aes(x = key, y = playlist_genre, fill = playlist_genre)) + 
  geom_boxplot() + 
  theme(legend.position = "NONE") + 
  scale_y_discrete(name = NULL) + 
  theme(panel.grid.major.y = element_blank()) 
p4 <- songs %>% 
  ggplot(aes(x = loudness, y = playlist_genre, fill = playlist_genre)) + 
  geom_boxplot() + 
  theme(legend.position = "NONE") + 
  scale_y_discrete(name = NULL) + 
  theme(panel.grid.major.y = element_blank()) 
p5 <- songs %>% 
  ggplot(aes(x = mode, y = playlist_genre, fill = playlist_genre)) + 
  geom_boxplot() + 
  theme(legend.position = "NONE") + 
  scale_y_discrete(name = NULL) + 
  theme(panel.grid.major.y = element_blank()) 
p6 <- songs %>% 
  ggplot(aes(x = speechiness, y = playlist_genre, fill = playlist_genre)) + 
  geom_boxplot() + 
  theme(legend.position = "NONE") + 
  scale_y_discrete(name = NULL) + 
  theme(panel.grid.major.y = element_blank()) 
p7 <- songs %>% 
  ggplot(aes(x = acousticness, y = playlist_genre, fill = playlist_genre)) + 
  geom_boxplot() + 
  theme(legend.position = "NONE") + 
  scale_y_discrete(name = NULL) + 
  theme(panel.grid.major.y = element_blank()) 
p8 <- songs %>% 
  ggplot(aes(x = instrumentalness, y = playlist_genre, fill = playlist_genre)) + 
  geom_boxplot() + 
  theme(legend.position = "NONE") + 
  scale_y_discrete(name = NULL) + 
  theme(panel.grid.major.y = element_blank()) 
p9 <- songs %>% 
  ggplot(aes(x = liveness, y = playlist_genre, fill = playlist_genre)) + 
  geom_boxplot() + 
  theme(legend.position = "NONE") + 
  scale_y_discrete(name = NULL) + 
  theme(panel.grid.major.y = element_blank()) 
p10 <- songs %>% 
  ggplot(aes(x = valence, y = playlist_genre, fill = playlist_genre)) + 
  geom_boxplot() + 
  theme(legend.position = "NONE") + 
  scale_y_discrete(name = NULL) + 
  theme(panel.grid.major.y = element_blank()) 
p11 <- songs %>% 
  ggplot(aes(x = tempo, y = playlist_genre, fill = playlist_genre)) + 
  geom_boxplot() + 
  theme(legend.position = "NONE") + 
  scale_y_discrete(name = NULL) + 
  theme(panel.grid.major.y = element_blank()) 
p12 <- songs %>% 
  ggplot(aes(x = duration_ms/60000, y = playlist_genre, fill = playlist_genre)) + 
  geom_boxplot() + 
  scale_x_continuous(name = "length in minutes") +
  theme(legend.position = "NONE") + 
  scale_y_discrete(name = NULL) + 
  theme(panel.grid.major.y = element_blank()) 
